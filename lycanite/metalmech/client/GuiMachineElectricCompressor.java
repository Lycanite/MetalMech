...
//TODO Merge GUIs
public class GuiMachineElectricCompressor extends GuiContainer {
	...
	// Constructor:
	public GuiMachineElectricCompressor(InventoryPlayer playerInventory, TileEntityMachineElectric tileEntityMachine) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString("Comprs.:", 10, 28, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        String texture = "/mods/" + MetalMech.modid + "/textures/guis/Compressor.png";
