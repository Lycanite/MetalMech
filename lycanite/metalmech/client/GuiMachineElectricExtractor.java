...
public class GuiMachineElectricExtractor extends GuiContainer {
	...
	// Constructor:
	public GuiMachineElectricExtractor(InventoryPlayer playerInventory, TileEntityMachineElectric tileEntityMachine) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString("Extract:", 10, 28, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        String texture = "/mods/" + MetalMech.modid + "/textures/guis/Extractor.png";
